...
public class OnetoOneActivity extends AppCompatActivity {
    ...
    private final List<OnetoOneMessage> onechatList = new ArrayList<>();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mAdapter = new OnetoOneAdapter(onechatList);
    ...
    private void saveMsgToDatabase() {
        ...
        messageKey = gnameRef.child("OnetoOneMessages").push().getKey();
        ...
        try{
            gnameRef.child("Messages").addChildEventListener(new ChildEventListener() {
                ...
                public void onChildAdded(DataSnapshot dataSnapshot, String s) {
                    OnetoOneMessage oneMessage = dataSnapshot.getValue(OnetoOneMessage.class);
                    onechatList.add(oneMessage);
